...
const links: {
    ...
    icon: React.FC<React.ComponentProps<'svg'>>
}[] = [
        {
            ...
            href: "https://docs.feedbackcentral.io",
            icon: BookOpenIcon
        },
        {
            title: 'Guides',
        ...
        },
        {
            ...
            href: "https://docs.feedbackcentral.io/blog",
            icon: RssIcon
        },
    ]
...
const social: {
    ...
    icon: React.FC<React.ComponentProps<'svg'>>
        ...
        {
            name: 'GitHub',
            href: 'https://github.com/feedbackcentral',
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
        ...
        <div className="bg-white">
            <main className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-xl mx-auto py-16 sm:py-24">
                    ...
                    <div className="mt-12">
                        ...
                        <div className="mt-8">
                            <a href={user ? "/app" : "/"} className="text-base font-medium text-indigo-600 hover:text-indigo-500">
            ...
            <footer className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
                <div className="border-t border-gray-200 py-12 text-center md:flex md:justify-between">
                    <p className="text-base text-gray-400">&copy; Feedback Central Team. All rights reserved.</p>
