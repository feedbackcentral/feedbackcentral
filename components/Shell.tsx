            ...
            <div>
                ...
                <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
                    ...
                    <div className="flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white">
                            ...
                            <nav className="mt-5 flex-1 px-2 bg-white space-y-1">
                                {(sidebars[router.pathname] ?? []).map((item) => (
                                    <a
                                        ...
                                        href={item.href}
                                        className={classNames(
                                            item.href == router.pathname ? 'bg-gray-100 text-gray-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900',
                        ...
                        {user.user && <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
                            <a href="#" className="flex-shrink-0 w-full group block">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <p className="text-sm font-medium text-gray-700 group-hover:text-gray-900">{user.user.id}</p>
